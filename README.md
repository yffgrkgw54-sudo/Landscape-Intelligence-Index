...
- **327 entries** fully coded with complete codification system
- **Category Distribution:**
  - Deep Time: 14 entries
  - Indigenous Epistemologies: 53 entries (anchors)
  - Earth System Science: 63 entries
  - Cybernetics & Systems: 19 entries
  - Landscape Architecture: 19 entries
  - Critical Materials & Extraction: 67 entries
  - Environmental Governance: 10 entries
  - Contemporary Theory: 63 entries
  - Ancient & Classical: 19 entries
- **82 anchor nodes** representing foundational knowledge systems
- **Sources:** 243 from LI Timeline + 84 from JACO Challenge
