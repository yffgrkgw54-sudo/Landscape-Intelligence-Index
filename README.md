...
- **295 entries** fully coded with complete codification system
- **Category Distribution:**
  - Deep Time: 14 entries
  - Indigenous Epistemologies: 53 entries (anchors)
  - Earth System Science: 56 entries
  - Cybernetics & Systems: 18 entries
  - Landscape Architecture: 19 entries
  - Critical Materials & Extraction: 44 entries
  - Environmental Governance: 10 entries
  - Contemporary Theory: 62 entries
  - Ancient & Classical: 19 entries
- **76 anchor nodes** representing foundational knowledge systems
- **Sources:** 243 from LI Timeline + 52 from JACO Challenge
